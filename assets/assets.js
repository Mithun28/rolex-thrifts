...
export const productDummyData = [
    ...
    },
    {
        id: "prod_7",
        name: "Burgundy Bag",
        description: "Elevate your everyday style with this elegant Burgundy Bag, designed to blend sophistication with practicality. Crafted from high-quality material, it features a rich burgundy finish that adds a timeless touch to any outfit. The spacious interior and sturdy handles make it perfect for daily use, while the sleek design ensures versatility—whether for work, casual outings, or evening events. A must-have accessory, this burgundy bag is both fashionable and functional.",
        mrp: 600,
        price: 550,
        images: [product_img7],
        storeId: "seller_1",
    ...
    },
    {
        id: "prod_8",
        name: "Men's Shorts",
        description: "Stay cool and stylish with these classic men’s jorts, the perfect blend of comfort and casual streetwear. Made from durable denim, these jean shorts feature a relaxed fit that offers ease of movement and all-day comfort. The timeless blue wash and versatile design make them easy to pair with T-shirts, polos, or hoodies for a laid-back look. Whether you’re hanging out with friends, heading to a summer festival, or running errands, these men’s jorts are a must-have staple for warm-weather outfits.",
        mrp: 1000,
        price: 890,
        images: [product_img8],
        storeId: "seller_1",
    ...
    {
        id: "prod_9",
        name: " Hand-woven Brown Tote Bag ",
        description: "Carry timeless elegance with this handcrafted woven tote bag in a warm brown finish. Designed with intricate detailing, this spacious bag combines durability with natural charm, making it perfect for beach days, casual outings, or summer getaways. The sturdy handles ensure comfort, while the versatile design pairs effortlessly with both casual and chic outfits. A must-have accessory, this woven brown tote bag adds a touch of rustic sophistication to your wardrobe.",
        mrp: 750,
        price: 750,
        images: [product_img9],
        storeId: "seller_1",
    ...
    {
        id: "prod_10",
        name: "White Dress for Summer",
        description: "Stay effortlessly chic this season with this white summer dress, designed for comfort and timeless elegance. Crafted from lightweight, breathable fabric, it keeps you cool on warm days while offering a flattering, flowy silhouette. The crisp white hue adds a touch of freshness, making it perfect for beach outings, garden parties, or casual daytime wear. Pair this versatile summer dress with sandals for a relaxed look or dress it up with heels and accessories for an evening out.",
        mrp: 1300,
        price: 900,
    ...
    {
        id: "prod_11",
        name: "White Elegent Jumpsuit",
        description: "Command attention with this white elegant office wear jumpsuit, designed to balance sophistication and comfort. Tailored with a sleek, structured fit, it features a flattering neckline and a streamlined silhouette that exudes professionalism. The crisp white fabric enhances its modern elegance, making it a perfect choice for boardroom meetings, corporate events, or formal office settings. Pair it with heels and minimal accessories for a polished, powerful look that transitions effortlessly from work to evening occasions.",
        mrp: 1800,
        price: 1600,
    ...
    },
    {
        ...
        description: "Elevate your style with these classic aviator sunglasses, designed with sleek gold frames and dark tinted lenses for a timeless look. Perfect for both casual outings and formal occasions, these sunglasses provide full UV protection while adding a touch of sophistication to any outfit. Lightweight yet durable, they’re a must-have accessory for sunny days, beach trips, or everyday wear. A versatile pair that blends fashion with function, these aviator sunglasses never go out of style.",
        mrp: 450,
        price: 350,
